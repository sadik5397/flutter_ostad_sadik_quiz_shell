...
class $AssetsCategoryGen {
  ...
  final AssetGenImage biology = const AssetGenImage('asset/category/biology.png');
  final AssetGenImage chemistry = const AssetGenImage('asset/category/chemistry.png');
  final AssetGenImage computer = const AssetGenImage('asset/category/computer.png');
  final AssetGenImage math = const AssetGenImage('asset/category/math.png');
}
